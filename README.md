...
| Language | File |
|---|---|
| English | [`docs/benchmark-list.en.md`](ai-benchmark-list-2026-github/docs/benchmark-list.en.md) |
| 中文（简体） | [`docs/benchmark-list.zh-CN.md`](ai-benchmark-list-2026-github/docs/benchmark-list.zh-CN.md) |
| 日本語 | [`docs/benchmark-list.ja.md`](ai-benchmark-list-2026-github/docs/benchmark-list.ja.md) |

## Visual overview

![Overview of Major AI Benchmarks as of 2026](ai-benchmark-list-2026-github/assets/ai-benchmark-overview-2026.png)
...
- [`data/benchmarks.csv`](ai-benchmark-list-2026-github/data/benchmarks.csv)
- [`data/benchmarks.json`](ai-benchmark-list-2026-github/data/benchmarks.json)
